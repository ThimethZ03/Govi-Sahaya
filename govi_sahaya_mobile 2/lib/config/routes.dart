...
import '../screens/profit_planner/edit_field_screen.dart';
...
class AppRoutes {
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case editField:
        final field = settings.arguments as Map<String, dynamic>;
        return _createRoute(EditFieldScreen(field: field));
      case editExpense:
